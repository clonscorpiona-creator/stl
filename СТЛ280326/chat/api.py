...
def serialize_message(message, current_user=None):
    ...
    data = {
        ...
        'user': {
            ...
            'is_senior_moderator': getattr(message.user.profile, 'is_senior_moderator', False),
            'is_staff': message.user.is_staff,
            'warning_count': getattr(message.user.profile, 'warning_count', 0),
            'is_banned': getattr(message.user.profile, 'is_banned', False),
        },
